...
bl_info = {
    "name": "Wavefront OBJ format with Vertex Color",
    "author": "Tomoaki Osada, Campbell Barton, Bastien Montagne, Hartyl",
    "version": (2, 3, 7),
    "blender": (2, 78, 0),
    "location": "File > Import-Export",
    "description": "Import-Export OBJ, Import OBJ mesh, UV's, materials, textures and Colors~",
    "warning": "",
